...
public class JoystickListener implements JoystickView.OnMoveListener {
    ...
    public JoystickListener(FragmentActivity activity, JoystickView joystick) {
    ...
    public void onMove(int angle, int strength) {
        long diff = System.nanoTime() - this.update;
        ...
        Pair<Integer, Integer> of = ofMove(angle, strength);
...
//            Toast.makeText(activity, "Joystick: " + msg, Toast.LENGTH_SHORT).show();
     ...
     * @param strength current strength 0~100%
     */
    public Pair<Integer, Integer> ofMove(int angle, int strength) {
